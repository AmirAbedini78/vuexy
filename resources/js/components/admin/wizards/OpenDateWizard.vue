<template>
  <div class="open-date-wizard">
    <VCard>
      <!-- Header with Step Counter -->
      <VCardTitle class="d-flex align-center justify-space-between">
        <div class="d-flex align-center">
          <span class="text-h6 me-3">Edit Open Date Listing</span>
